 ...
 * Original file: /npm/swiper@11.2.10/swiper.mjs
 *
   ...
   return (
      ...
      T ||
         (T = (function (e) {
            ...
            let m = "MacIntel" === r;
            return (
               !p && m && s.touch && ["1024x1366", "1366x1024", "834x1194", "1194x834", "834x1112", "1112x834", "768x1024", "1024x768", "820x1180", "1180x820", "810x1080", "1080x810"].indexOf(`${l}x${d}`) >= 0 && ((p = a.match(/(Version)\/([\d.]+)/)), p || (p = [0, 1, "13_0_0"]), (m = !1)),
...
var O = {
   updateSize: function () {
      ...
      (t = void 0 !== e.params.width && null !== e.params.width ? e.params.width : i.clientWidth),
         ...
         (0 === t && e.isHorizontal()) ||
            (0 === s && e.isVertical()) ||
            ((t = t - parseInt(v(i, "padding-left") || 0, 10) - parseInt(v(i, "padding-right") || 0, 10)), (s = s - parseInt(v(i, "padding-top") || 0, 10) - parseInt(v(i, "padding-bottom") || 0, 10)), Number.isNaN(t) && (t = 0), Number.isNaN(s) && (s = 0), Object.assign(e, { width: t, height: s, size: e.isHorizontal() ? t : s }));
   },
      ...
      for (let i = 0; i < u; i += 1) {
         ...
         if (((I = 0), c[i] && (r = c[i]), C && e.grid.updateSlide(i, r, c), !c[i] || "none" !== v(r, "display"))) {
            ...
            c[i] && (c[i].swiperSlideSize = I),
               g.push(I),
               s.centeredSlides
                  ? ((E = E + I / 2 + M / 2 + y), 0 === M && 0 !== i && (E = E - n / 2 - y), 0 === i && (E = E - n / 2 - y), Math.abs(E) < 0.001 && (E = 0), s.roundLengths && (E = Math.floor(E)), P % s.slidesPerGroup == 0 && f.push(E), m.push(E))
                  : (s.roundLengths && (E = Math.floor(E)), (P - Math.min(e.params.slidesPerGroupSkip, P)) % e.params.slidesPerGroup == 0 && f.push(E), m.push(E), (E = E + I + y)),
               (e.virtualSize += I + y),
               (M = I),
               (P += 1);
         }
      }
      if (((e.virtualSize = Math.max(e.virtualSize, n) + T), a && o && ("slide" === s.effect || "coverflow" === s.effect) && (i.style.width = `${e.virtualSize + y}px`), s.setWrapperSize && (i.style[e.getDirectionLabel("width")] = `${e.virtualSize + y}px`), C && e.grid.updateWrapperSize(I, f), !s.centeredSlides)) {
         const t = [];
   ...
   updateSlidesProgress: function (e) {
      ...
      for (let e = 0; e < i.length; e += 1) {
         ...
         const c = (a + (s.centeredSlides ? t.minTranslate() : 0) - d) / (l.swiperSlideSize + o),
            ...
            m = (u >= 0 && u < t.size - 1) || (h > 1 && h <= t.size) || (u <= 0 && h >= t.size);
         m && (t.visibleSlides.push(l), t.visibleSlidesIndexes.push(e)), P(l, m, s.slideVisibleClass), P(l, f, s.slideFullyVisibleClass), (l.progress = r ? -c : c), (l.originalProgress = r ? -p : p);
      }
   },
   ...
   updateActiveIndex: function (e) {
      ...
      Object.assign(t, { previousSnapIndex: o, snapIndex: l, previousRealIndex: a, realIndex: u, previousIndex: n, activeIndex: d }), t.initialized && k(t), t.emit("activeIndexChange"), t.emit("snapIndexChange"), (t.initialized || t.params.runCallbacksOnInit) && (a !== u && t.emit("realIndexChange"), t.emit("slideChange"));
   },
...
var A = {
   ...
   setTranslate: function (e, t) {
      ...
      s.isHorizontal() ? (l = i ? -e : e) : (d = e),
         ...
         r.cssMode ? (n[s.isHorizontal() ? "scrollLeft" : "scrollTop"] = s.isHorizontal() ? -l : -d) : r.virtualTranslate || (s.isHorizontal() ? (l -= s.cssOverflowAdjustment()) : (d -= s.cssOverflowAdjustment()), (n.style.transform = `translate3d(${l}px, ${d}px, 0px)`));
   ...
   slideToClickedSlide: function () {
      ...
      if (t.loop) {
         ...
         (r = parseInt(e.clickedSlide.getAttribute("data-swiper-slide-index"), 10)),
            t.centeredSlides
               ? e.slideToLoop(r)
               : n > (l ? (e.slides.length - i) / 2 - (e.params.grid.rows - 1) : e.slides.length - i)
               ? (e.loopFix(),
...
var _ = {
   ...
   loopFix: function (e) {
      ...
      const { slides: c, allowSlidePrev: p, allowSlideNext: u, slidesEl: h, params: m } = d,
         { centeredSlides: v, initialSlide: g } = m;
      if (((d.allowSlidePrev = !0), (d.allowSlideNext = !0), d.virtual && m.virtual.enabled))
         return (
            s && (m.centeredSlides || 0 !== d.snapIndex ? (m.centeredSlides && d.snapIndex < m.slidesPerView ? d.slideTo(d.virtual.slides.length + d.snapIndex, 0, !1, !0) : d.snapIndex === d.snapGrid.length - 1 && d.slideTo(d.virtual.slidesBefore, 0, !1, !0)) : d.slideTo(d.virtual.slides.length, 0, !1, !0)),
            (d.allowSlidePrev = p),
            (d.allowSlideNext = u),
            void d.emit("loopFix")
         );
      ...
      c.length < w + T || ("cards" === d.params.effect && c.length < w + 2 * T)
         ? f("Swiper Loop Warning: The number of slides is not enough for loop mode, it will be disabled or not function properly. You need to add more slides (or make duplicates) or lower the values of slidesPerView and slidesPerGroup parameters")
         : b && "row" === m.grid.fill && f("Swiper Loop Warning: Loop mode is not compatible with grid.fill = `row`");
      const x = [],
         y = [],
      ...
      if (
         ...
         "cards" === d.params.effect && c.length < w + 2 * T && (y.includes(n) && y.splice(y.indexOf(n), 1), x.includes(n) && x.splice(x.indexOf(n), 1)),
         I &&
            x.forEach((e) => {
      ...
      if (((d.allowSlidePrev = p), (d.allowSlideNext = u), d.controller && d.controller.control && !o)) {
         ...
         Array.isArray(d.controller.control)
            ...
            : d.controller.control instanceof d.constructor && d.controller.control.params.loop && d.controller.control.loopFix({ ...e, slideTo: d.controller.control.params.slidesPerView === m.slidesPerView && s });
      }
      d.emit("loopFix");
   },
...
function B(e) {
   ...
   if ((new Date().getTime(), !1 !== n._loopSwapReset && r.isMoved && r.allowThresholdMove && w !== s.touchesDirection && S && T && Math.abs(v) >= 1)) return Object.assign(a, { startX: u, startY: h, currentX: u, currentY: h, startTranslate: r.currentTranslate }), (r.loopSwapReset = !0), void (r.startTranslate = r.currentTranslate);
   ...
   if (
      ...
      v > 0
         ? (S &&
              ...
              r.currentTranslate > (n.centeredSlides ? s.minTranslate() - s.slidesSizesGrid[s.activeIndex + 1] - ("auto" !== n.slidesPerView && s.slides.length - n.slidesPerView >= 2 ? s.slidesSizesGrid[s.activeIndex + 1] + s.params.spaceBetween : 0) - s.params.spaceBetween : s.minTranslate()) &&
              s.loopFix({ direction: "prev", setTranslate: !0, activeSlideIndex: 0 }),
           r.currentTranslate > s.minTranslate() && ((b = !1), n.resistance && (r.currentTranslate = s.minTranslate() - 1 + (-s.minTranslate() + r.startTranslate + v) ** x)))
         : v < 0 &&
           (S &&
              T &&
              r.allowThresholdMove &&
              r.currentTranslate < (n.centeredSlides ? s.maxTranslate() + s.slidesSizesGrid[s.slidesSizesGrid.length - 1] + s.params.spaceBetween + ("auto" !== n.slidesPerView && s.slides.length - n.slidesPerView >= 2 ? s.slidesSizesGrid[s.slidesSizesGrid.length - 1] + s.params.spaceBetween : 0) : s.maxTranslate()) &&
           ...
           r.currentTranslate < s.maxTranslate() && ((b = !1), n.resistance && (r.currentTranslate = s.maxTranslate() + 1 - (s.maxTranslate() - r.startTranslate - v) ** x))),
      ...
      breakpoints: {
         setBreakpoint: function () {
            ...
            h && !f
               ...
               : !h && f && (n.classList.add(`${r.containerModifierClass}grid`), ((u.grid.fill && "column" === u.grid.fill) || (!u.grid.fill && "column" === r.grid.fill)) && n.classList.add(`${r.containerModifierClass}grid-column`), e.emitContainerClasses()),
            ...
            Object.assign(e, { allowTouchMove: e.params.allowTouchMove, allowSlideNext: e.params.allowSlideNext, allowSlidePrev: e.params.allowSlidePrev }),
               ...
               s && (S ? (e.loopDestroy(), e.loopCreate(t), e.updateSlides()) : !T && x ? (e.loopCreate(t), e.updateSlides()) : T && !x && e.loopDestroy()),
               e.emit("breakpoint", u);
         },
...
class J {
   constructor() {
      ...
      const l = {};
      o.modules.forEach((e) => {
         e({ params: t, swiper: o, extendParams: q(t, l), on: o.on.bind(o), once: o.once.bind(o), off: o.off.bind(o), emit: o.emit.bind(o) });
      });
      const d = c({}, Y, l);
      return (
         (o.params = c({}, d, K, t)),
      ...
      function (e) {
         ...
         const a = [],
            ...
            l = function (e, s) {
               ...
               i.observe(e, { attributes: void 0 === s.attributes || s.attributes, childList: t.isElement || (void 0 === s.childList || s).childList, characterData: void 0 === s.characterData || s.characterData }), a.push(i);
            };
...
//# sourceMappingURL=/sm/87b1fef29cc2a3b33e938cedc573a44e25ee4e0f39711a2e8343d055d636673c.map
